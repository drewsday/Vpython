...
ball1 = sphere(pos=vector(10,10,0),color=color.green, radius=1)
ball2 = sphere(pos=vector(-10,10,0),color=color.red, radius=1)
ball3 = sphere(pos=vector(0,0,0),color=color.blue,radius=1)
